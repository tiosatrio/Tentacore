...
import { AppsMenu } from "@inisiacore_theme/webclient/appsmenu/appsmenu";
import { AppsBar } from "@inisiacore_theme/webclient/appsbar/appsbar";
import { SwitchCompanyMenu } from "@web/webclient/switch_company_menu/switch_company_menu";
import { UserMenu } from "@web/webclient/user_menu/user_menu";

patch(NavBar.prototype, "inisiacore_theme.NavBar", {
    setup() {
        this._super();
...
patch(NavBar, "inisiacore_theme.NavBar", {
    components: {
        ...NavBar.components,
        AppsMenu,
        AppsBar,
