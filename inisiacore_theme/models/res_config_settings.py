...
class ResConfigSettings(models.TransientModel):
    ...
    def set_values(self):
        ...
        colors = self.env['web_editor.assets'].get_variables_values(
            '/inisiacore_theme/static/src/colors.scss', 'web._assets_primary_variables', variables
        )
        colors_changed = []
        ...
        if(any(colors_changed)):
            variables = [
                {'name': 'o-brand-odoo', 'value': self.theme_color_brand or "#46453F"},
                {'name': 'o-brand-primary', 'value': self.theme_color_primary or "#4EDF26"},
                {'name': 'mk-required-color', 'value': self.theme_color_required or "#9CD48C"},
                {'name': 'mk-apps-color', 'value': self.theme_color_menu or "#FFFFFF"},
                {'name': 'mk-appbar-color', 'value': self.theme_color_appbar_color or "#46453F"},
                {'name': 'mk-appbar-background', 'value': self.theme_color_appbar_background or "#FFFFFF"},
            ]
