...
class IrUiMenu_inisia(models.Model):
    _inherit = "ir.ui.menu"

    inisiacore = fields.Char(string="inisiacore", default="INISIACORE")
    ...
    def load_menus(self, debug):
        ...
        """
        fields = ['name', 'sequence', 'parent_id', 'action', 'web_icon', 'web_icon_data', 'inisiacore']
